      ...
      >
            ...
            <div className="space-y-4 animate-in fade-in duration-150">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed">
                      Deploy a dedicated, tokenized sandbox room directly on the proprietary ACR Cloud mesh (<code className="text-cyan-300 font-mono-code">cloud.acr.chat</code>). No local daemon or CLI installation required.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3.5 rounded-xl border border-white/[0.08] bg-black/40 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>Cloud Relay Node: <span className="font-mono-code text-cyan-300">143.198.98.229:20443</span></span>
                </div>
          ...
          {activeTab === 'tunnel' && (
            <div className="space-y-4 animate-in fade-in duration-150">
              ...
              <div className="space-y-1 text-[11px] text-slate-400 bg-white/[0.02] p-3 rounded-xl border border-white/[0.06]">
                ...
                <div>• Outbound WebSocket to <code className="text-cyan-300 font-mono-code">wss://cloud.acr.chat/tunnel</code></div>
        ...
        <div className="flex items-center justify-between px-6 py-3.5 border-t border-white/[0.08] bg-black/50 text-[11px] text-slate-400">
          <div className="flex items-center gap-2">
            ...
            <span>Open Source Protocol • Closed-Source Cloud Moat</span>
          </div>
          <button
            onClick={onClose}
